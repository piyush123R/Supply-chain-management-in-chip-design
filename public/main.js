...
$(document).ready(function(){
    ...
    $('#btn-login').click(function (event){
        ...
        $('#registerchip').click(function (event){
            event.preventDefault(); 
            $.ajax({
                type: 'POST',
                url:"http://127.0.0.1:5000/regchip ",
                headers: {
                    "content-type":"application/x-www-form-urlencoded"
                },
                data: {
    ...
    $('#transferchip').click(function(event){
        event.preventDefault();
        $.ajax({
            type: 'POST',
    ...
    $('#track').click(function(event){
        ...
        $.ajax({
            ...
            success: function (data){
                ...
                $('#chip_id_display').html(t[0].ownerid)
            }
        })
    })
